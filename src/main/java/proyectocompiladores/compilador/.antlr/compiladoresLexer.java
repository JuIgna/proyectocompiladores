...
public class compiladoresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DIGITO", "CARACTER", "NUMERO", "DOUBLE_LITERAL", "CHAR_LITERAL", "INT", 
			"DOUBLE", "VOID", "CHAR", "IF", "ELSE", "FOR", "WHILE", "RETURN", "BOOL", 
			"TRUE", "FALSE", "PRINTF", "PYC", "COMA", "IGUAL", "SUMA", "RESTA", "MULT", 
			"DIV", "MOD", "PA", "PC", "LLA", "LLC", "CORCHETE", "CORCHETE_C", "COMP", 
			"ID", "PUNTO", "STRING", "AND", "OR", "INCREMENTO", "DECREMENTO", "WS", 
			"LC", "BC", "ERROR"
		};
	}
