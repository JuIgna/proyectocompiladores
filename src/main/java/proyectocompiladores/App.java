...
public class App {
    public static void main(String[] args) {
        try {
            ...
            // 1. Análisis Léxico
            System.out.println("\n=== 1. ANÁLISIS LÉXICO ===");
            CharStream input = CharStreams.fromFileName("input/prueba.cpp");
            ...
            try (PrintWriter escritorErrores = new PrintWriter(new FileWriter("output/errores.txt"))) {
                ...
                if (erroresSintacticos) {
                    System.out.println("---> Errores sintacticos detectados, verifique el archivo errores.txt. Se detiene la compilación. ");
                    return;
                }
